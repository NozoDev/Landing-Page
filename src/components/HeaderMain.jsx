...
const HeaderMain = () => {
  return (
    <main className="grid md:grid-cols-2 max-w-[1200px] mx-auto md:h-[400px] ">
      ...
      <div className="order-2 md:order-1 flex justify-center items-center text-center ">
        <div className="md:first-letter:py-4 md:text-left md:flex md:flex-col md:items-start  ">
      ...
      <div className="order-1 md:order-2 md:flex md:flex-col md:items-start">
        <div className="h-[420px]">
          {/* Imagen de desktop */}
          <img
            className="md:block hidden md:w-full md:h-[470px] lg:h-[650px] xl:left-3/4"
          ...
          <div className="bottom-0">
            <img
              className="relative block md:hidden w-[100%] md:550px h-[390px]"
            ...
            <div className="flex justify-center items-center">
              <img
                className="absolute top-0 w-[350px] h-[420px] md:w-[390px] md:h-[590px] lg:w-[460px] lg:h-[780px] xl:-top-20 xl:w-[550px] xl:left-[60%]"
